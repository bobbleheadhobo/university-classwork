...
# Lab2
# 02/23/23
# Purpose: Multiply binary string using recurive divide and conquer algorithm with the Gaussion trick
...
def main():
    ...
    # TEST 3
    x = "1111010111001100110101011"
    y = "1011010101011011111010011"
...
def multiply(x:str, y:str):
    ...
    P2 = str(multiply(xSecond, ySecond))
    P3 = str(multiply(addBinary(xFirst, xSecond), addBinary(yFirst, ySecond)))
    ...
    T2 = str(subtractBinary(subtractBinary(P3, P1), P2))
